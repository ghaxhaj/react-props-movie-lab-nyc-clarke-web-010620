...
export default class MovieCard extends Component {
  ...
  selectImage = poster => {
    ...
    // Object.keys(posterMap).map(title => title === chicken ? posterMap[title] : null)
  //   // Object.keys(posterMap).map((keyName, props) => {console.log(props)})
  }
  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster = {this.selectImage(this.props.poster)}
        />
